namespace Blackjack.Services
{
    ...
    public class BasicStrategy
    {
        ...
        {
            _hardTotalsStrategy = BasicStrategy.InitializeHardTotalsStrategy();
            _softTotalsStrategy = BasicStrategy.InitializeSoftTotalsStrategy();
            _pairStrategy = BasicStrategy.InitializePairStrategy();
        }
        ...
        /// </summary>
        private static int GetDealerValue(Models.Card card)
        {
        ...
        /// </summary>
        private static Dictionary<(int, int), PlayerAction> InitializeHardTotalsStrategy()
        {
        ...
        /// </summary>
        private static Dictionary<(int, int), PlayerAction> InitializeSoftTotalsStrategy()
        {
            var strategy = new Dictionary<(int, int), PlayerAction>();
        ...
        /// </summary>
        private static Dictionary<(int, int), PlayerAction> InitializePairStrategy()
        {
            var strategy = new Dictionary<(int, int), PlayerAction>();
