...
"@
    ...
    $svg | Out-File -FilePath "Resources\Images\Cards\$fileName" -Encoding UTF8 -NoNewline
}
...
"@
    ...
    $svg | Out-File -FilePath "Resources\Images\Cards\card_back.svg" -Encoding UTF8 -NoNewline
}
